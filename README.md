...
This project can be either used 
- to create a website using built-in features
- or as a foundation for you to start vibe-coding you own custom site (and editor for it) and save some time/tokens by using this project as a foundation.

Websites built with it:
- https://alexeyperov.github.io/
- https://kometa.games/
